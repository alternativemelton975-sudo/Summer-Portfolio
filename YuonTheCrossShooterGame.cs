...
app.UseStaticFiles();
// Redirect /game or /Game to the playable endpoint (case-insensitive) using middleware to avoid endpoint ambiguity
...
// Minimal single-file HTML5 cross shooter game at /cross-shooter
...
<body>
  ...
  (function(){
    function start(){
      ...
      // single-shot fire (removed duplicate handler)
